...
prespecified tolerance. Appendix Tables~\ref{tab:numerical_cells_f1_f2}
and~\ref{tab:numerical_cells_f4_f5} expose all 32 paired intervention cells.
...
Tables~\ref{tab:numerical_cells_f1_f2} and~\ref{tab:numerical_cells_f4_f5}.
...
cells (Appendix~\ref{app:numerical_cells}). Only the 96-segment F4 request
...
Cross-engine portability & MuJoCo retained 30/30 compound passes on flat and inclined surfaces but 0/15 on the cylinder & Zero-shot stress test under a documented tangential calibration mismatch; not solver equivalence or hardware evidence \\
\bottomrule
\end{tabular}
\end{table*}
