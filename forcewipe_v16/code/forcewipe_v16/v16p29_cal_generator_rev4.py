"""Result-independent V16.29 CAL generator with a disjoint planner RNG domain."""
...
def frozen_cal_blocks() -> tuple[dict, ...]:
    """Return the unchanged ten deterministic CAL blocks without running physics."""
    ...
    for index in range(10):
        ...
        blocks.append({
            ...
            "planner_seed": int(PLANNER_SEED_ROOT + index),
