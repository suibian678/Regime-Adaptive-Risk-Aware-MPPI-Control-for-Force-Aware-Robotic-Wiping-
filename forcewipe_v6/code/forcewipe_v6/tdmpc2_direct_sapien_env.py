...
from .sapien_sandbox_binding import _quat_conjugate, _quat_rotate, _quaternion
from .tdmpc2_direct_firstpass import (
...
class V6DirectFirstPassEnv(gym.Env):
    ...
    def _geometry(self) -> dict[str, Any]:
        from forcewipe_v4.scenarios import surface_normal
