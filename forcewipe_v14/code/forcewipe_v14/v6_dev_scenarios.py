"""Fresh development scenarios for V14 learned direct control."""
...
def v14_development_scenario(target_force_n: float, scenario_seed: int, scenario_id: int):
    ...
    spec = ScenarioSpec(
        ...
        role="DEV",
        seed_namespace="v5_dev_v14_native_tdmpc2_closed_loop_20260828",
